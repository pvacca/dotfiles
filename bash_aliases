...
alias pipup='python -m pip install -U pip && pip install -U setuptools wheel distlib six platformdirs packaging virtualenv pipenv certifi filelock && pip list --outdated'
